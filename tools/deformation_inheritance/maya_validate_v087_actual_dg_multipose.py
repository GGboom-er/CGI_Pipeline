...
REPORT_JSON = INFO_DIR / "v087_actual_dg_multipose_report.json"
REPORT_CSV = INFO_DIR / "v087_actual_dg_multipose_summary.csv"
ERROR_ARRAYS = INFO_DIR / "v087_actual_dg_multipose_error_arrays.npz"

SOURCE = "M_Head_base"
BASE_KEY = "v087_base_hybrid_m0010"
CANDIDATES = [
    (BASE_KEY, "A_V087_001_baseHybrid"),
    ("v087_rt_raw_topk", "A_V087_002_rawRT_DIAGNOSTIC"),
    ("v087_rt_guard_strict", "A_V087_003_guardStrictRT"),
    ("v087_rt_guard_balanced", "A_V087_004_guardBalancedRT"),
    ("v087_rts_guard_balanced", "A_V087_005_guardBalancedRTS"),
]
...
def _candidate_key_to_set_prefix(key: str) -> str:
    return "CDFDIAG_V087_ACTUAL_" + key.upper().replace("V087_", "").replace("_", "")
...
def _execute() -> dict:
    ...
    report = {
        ...
        "candidate_summary": {},
        "sets": {},
        "note": "真实 Maya DG 多控制器验收；source 侧关闭 blendShape，只评估 Skin 权重复制。",
    }
    error_arrays = {}
