# cgi_pipeline/server/celeryconfig.py
# ── CGI Pipeline 单队列配置 ──
import os
...
task_routes = {
    'cgi_pipeline.core.tasks.execute_api_operation': {'queue': 'cgi_queue'},
    'cgi_pipeline.core.tasks.execute_api_chain': {'queue': 'cgi_queue'},
    'cgi_pipeline.core.tasks.execute_workflow': {'queue': 'cgi_queue'},
}
