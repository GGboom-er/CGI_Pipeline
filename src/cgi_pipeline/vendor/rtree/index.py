...
__c_api_version__ = cgi_pipeline.core.rt.SIDX_Version()
...
def _get_bounds(handle, bounds_fn, interleaved):
    ...
    cgi_pipeline.core.rt.Index_Free(ctypes.cast(p_mins, ctypes.POINTER(ctypes.c_void_p)))
    cgi_pipeline.core.rt.Index_Free(ctypes.cast(p_maxs, ctypes.POINTER(ctypes.c_void_p)))
...
def _get_data(handle):
    ...
    cgi_pipeline.core.rt.IndexItem_GetData(handle, ctypes.byref(d), ctypes.byref(length))
    c = ctypes.cast(d, ctypes.POINTER(ctypes.c_void_p))
    if length.value == 0:
        cgi_pipeline.core.rt.Index_Free(c)
        return None
...
class Index:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.properties.type == RT_TPRTree and not hasattr(
            cgi_pipeline.core.rt, "Index_InsertTPData"
        ):
            raise RuntimeError(
    ...
    def set_result_limit(self, value):
        return cgi_pipeline.core.rt.Index_SetResultSetOffset(self.handle, value)

    def get_result_limit(self):
        return cgi_pipeline.core.rt.Index_GetResultSetOffset(self.handle)

    result_limit = property(get_result_limit, set_result_limit)

    def set_result_offset(self, value):
        return cgi_pipeline.core.rt.Index_SetResultSetLimit(self.handle, value)

    def get_result_offset(self):
        return cgi_pipeline.core.rt.Index_GetResultSetLimit(self.handle)
    ...
    def insert(self, id: int, coordinates: Any, obj: object = None) -> None:
        ...
        cgi_pipeline.core.rt.Index_InsertData(
    ...
    def count(self, coordinates: Any) -> int:
        ...
        cgi_pipeline.core.rt.Index_Intersects_count(
            self.handle,
            p_mins,
            p_maxs,
            self.properties.dimension,
    ...
    def _countTP(
        ...
        cgi_pipeline.core.rt.Index_TPIntersects_count(
            self.handle,
            p_mins,
            p_maxs,
            pv_mins,
    ...
    def contains(
        ...
        try:
            cgi_pipeline.core.rt.Index_Contains_id
    ...
    def intersection(
        ...
        cgi_pipeline.core.rt.Index_Intersects_id(
            self.handle,
            p_mins,
            p_maxs,
            self.properties.dimension,
    ...
    def _intersectionTP(self, coordinates, velocities, times, objects=False):
        ...
        if objects:
            call = cgi_pipeline.core.rt.Index_TPIntersects_obj
            it = ctypes.pointer(ctypes.c_void_p())
        else:
            call = cgi_pipeline.core.rt.Index_TPIntersects_id
            it = ctypes.pointer(ctypes.c_int64())
    ...
    def _intersection_obj(self, coordinates, objects):
        ...
        cgi_pipeline.core.rt.Index_Intersects_obj(
            self.handle,
            p_mins,
            p_maxs,
            self.properties.dimension,
    ...
    def _contains_obj(self, coordinates: Any, objects):
        ...
        try:
            cgi_pipeline.core.rt.Index_Contains_obj
        except AttributeError:
            return None
    ...
    def _get_objects(self, it, num_results, objects):
        ...
        try:
            ...
            cgi_pipeline.core.rt.Index_DestroyObjResults(its, num_results)
    ...
    def _get_ids(self, it, num_results):
        ...
        try:
            ...
            cgi_pipeline.core.rt.Index_Free(its)
    ...
    def _nearest_obj(self, coordinates, num_results, objects):
        ...
        cgi_pipeline.core.rt.Index_NearestNeighbors_obj(
            self.handle,
            p_mins,
            p_maxs,
            self.properties.dimension,
    ...
    def nearest(
        ...
        cgi_pipeline.core.rt.Index_NearestNeighbors_id(
            self.handle,
            p_mins,
            p_maxs,
            self.properties.dimension,
    ...
    def intersection_v(self, mins, maxs):
        ...
        while True:
            cgi_pipeline.core.rt.Index_Intersects_id_v(
                self.handle,
                n - offn,
                d,
                len(ids) - offi,
    ...
    def nearest_v(
        ...
        *,
        ...
        while True:
            cgi_pipeline.core.rt.Index_NearestNeighbors_id_v(
                self.handle,
    ...
    def _nearestTP(self, coordinates, velocities, times, num_results=1, objects=False):
        ...
        if objects:
            it = ctypes.pointer(ctypes.c_void_p())
            call = cgi_pipeline.core.rt.Index_TPNearestNeighbors_obj
        else:
            it = ctypes.pointer(ctypes.c_int64())
            call = cgi_pipeline.core.rt.Index_TPNearestNeighbors_id
    ...
    def get_bounds(self, coordinate_interleaved=None):
        ...
        return _get_bounds(self.handle, cgi_pipeline.core.rt.Index_GetBounds, coordinate_interleaved)
    ...
    def delete(self, id: int, coordinates: Any) -> None:
        ...
        p_mins, p_maxs = self.get_coordinate_pointers(coordinates)
        cgi_pipeline.core.rt.Index_DeleteData(
    ...
    def _deleteTP(
        ...
        pv_mins, pv_maxs = self.get_coordinate_pointers(velocities)
        t_start, t_end = self._get_time_doubles(times)
        cgi_pipeline.core.rt.Index_DeleteTPData(
            self.handle,
            id,
            p_mins,
            p_maxs,
    ...
    def valid(self) -> bool:
        return bool(cgi_pipeline.core.rt.Index_IsValid(self.handle))

    def clearBuffer(self):
        return cgi_pipeline.core.rt.Index_ClearBuffer(self.handle)
    ...
    def _create_idx_from_stream(self, stream):
        ...
        stream = cgi_pipeline.core.NEXTFUNC(py_next_item)
    ...
    def leaves(self):
        ...
        cgi_pipeline.core.rt.Index_GetLeaves(
            self.handle,
        ...
        for i in range(count):
            ...
            cgi_pipeline.core.rt.Index_Free(
...
class Item:
    ...
    def __init__(self, loads, handle, owned=False) -> None:
        ...
        self.id = cgi_pipeline.core.rt.IndexItem_GetID(self.handle)

        self.object = None
        self.object = self.get_object(loads)
        self.bounds = _get_bounds(self.handle, cgi_pipeline.core.rt.IndexItem_GetBounds, False)
...
class Handle:
    ...
    def __del__(self) -> None:
        try:
            ...
            # The cgi_pipeline.core.py model doesn't have
            # cgi_pipeline.core.rt available anymore and it was tore
...
class IndexHandle(Handle):
    _create = cgi_pipeline.core.rt.Index_Create
    _destroy = cgi_pipeline.core.rt.Index_Destroy

    def flush(self) -> None:
        try:
            cgi_pipeline.core.rt.Index_Flush
            if self._ptr is not None:
                cgi_pipeline.core.rt.Index_Flush(self._ptr)
        except AttributeError:
            pass


class IndexStreamHandle(IndexHandle):
    _create = cgi_pipeline.core.rt.Index_CreateWithStream


try:

    class IndexArrayHandle(IndexHandle):
        _create = cgi_pipeline.core.rt.Index_CreateWithArray
except AttributeError:
    pass


class PropertyHandle(Handle):
    _create = cgi_pipeline.core.rt.IndexProperty_Create
    _destroy = cgi_pipeline.core.rt.IndexProperty_Destroy
...
class Property:
    ...
    def get_index_type(self) -> int:
        try:
            ...
            type = cgi_pipeline.core.rt.IndexProperty_GetIndexType(self.handle)
            self._type: int = type
            return type

    def set_index_type(self, value: int) -> None:
        self._type = value
        return cgi_pipeline.core.rt.IndexProperty_SetIndexType(self.handle, value)
    ...
    def get_variant(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetIndexVariant(self.handle)

    def set_variant(self, value: int) -> None:
        return cgi_pipeline.core.rt.IndexProperty_SetIndexVariant(self.handle, value)
    ...
    def get_dimension(self) -> int:
        try:
            ...
            dim = cgi_pipeline.core.rt.IndexProperty_GetDimension(self.handle)
    ...
    def set_dimension(self, value: int) -> None:
        ...
        return cgi_pipeline.core.rt.IndexProperty_SetDimension(self.handle, value)
    ...
    def get_storage(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetIndexStorage(self.handle)

    def set_storage(self, value: int) -> None:
        return cgi_pipeline.core.rt.IndexProperty_SetIndexStorage(self.handle, value)
    ...
    def get_pagesize(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetPagesize(self.handle)

    def set_pagesize(self, value: int) -> None:
        if value <= 0:
            raise RTreeError("Pagesize must be > 0")
        return cgi_pipeline.core.rt.IndexProperty_SetPagesize(self.handle, value)
    ...
    def get_buffering_capacity(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetBufferingCapacity(self.handle)

    def set_buffering_capacity(self, value: int) -> None:
        if value <= 0:
            raise RTreeError("buffering_capacity must be > 0")
        return cgi_pipeline.core.rt.IndexProperty_SetBufferingCapacity(self.handle, value)

    buffering_capacity = property(get_buffering_capacity, set_buffering_capacity)
    """Buffering capacity"""

    def get_tight_mbr(self):
        return bool(cgi_pipeline.core.rt.IndexProperty_GetEnsureTightMBRs(self.handle))

    def set_tight_mbr(self, value):
        value = bool(value)
        return bool(cgi_pipeline.core.rt.IndexProperty_SetEnsureTightMBRs(self.handle, value))

    tight_mbr = property(get_tight_mbr, set_tight_mbr)
    """Uses tight bounding rectangles"""

    def get_overwrite(self):
        return bool(cgi_pipeline.core.rt.IndexProperty_GetOverwrite(self.handle))

    def set_overwrite(self, value):
        value = bool(value)
        return bool(cgi_pipeline.core.rt.IndexProperty_SetOverwrite(self.handle, value))

    overwrite = property(get_overwrite, set_overwrite)
    """Overwrite existing index files"""

    def get_near_minimum_overlap_factor(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetNearMinimumOverlapFactor(self.handle)

    def set_near_minimum_overlap_factor(self, value: int) -> None:
        if value <= 0:
            raise RTreeError("near_minimum_overlap_factor must be > 0")
        return cgi_pipeline.core.rt.IndexProperty_SetNearMinimumOverlapFactor(self.handle, value)
    ...
    def get_writethrough(self):
        return bool(cgi_pipeline.core.rt.IndexProperty_GetWriteThrough(self.handle))

    def set_writethrough(self, value):
        value = bool(value)
        return bool(cgi_pipeline.core.rt.IndexProperty_SetWriteThrough(self.handle, value))

    writethrough = property(get_writethrough, set_writethrough)
    """Write through caching"""

    def get_fill_factor(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetFillFactor(self.handle)

    def set_fill_factor(self, value: int) -> None:
        return cgi_pipeline.core.rt.IndexProperty_SetFillFactor(self.handle, value)
    ...
    def get_split_distribution_factor(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetSplitDistributionFactor(self.handle)

    def set_split_distribution_factor(self, value: int) -> None:
        return cgi_pipeline.core.rt.IndexProperty_SetSplitDistributionFactor(self.handle, value)
    ...
    def get_tpr_horizon(self):
        return cgi_pipeline.core.rt.IndexProperty_GetTPRHorizon(self.handle)

    def set_tpr_horizon(self, value):
        return cgi_pipeline.core.rt.IndexProperty_SetTPRHorizon(self.handle, value)

    tpr_horizon = property(get_tpr_horizon, set_tpr_horizon)
    """TPR horizon"""

    def get_reinsert_factor(self):
        return cgi_pipeline.core.rt.IndexProperty_GetReinsertFactor(self.handle)

    def set_reinsert_factor(self, value):
        return cgi_pipeline.core.rt.IndexProperty_SetReinsertFactor(self.handle, value)

    reinsert_factor = property(get_reinsert_factor, set_reinsert_factor)
    """Reinsert factor"""

    def get_filename(self):
        return cgi_pipeline.core.rt.IndexProperty_GetFileName(self.handle).decode()

    def set_filename(self, value):
        if isinstance(value, str):
            value = value.encode("utf-8")
        return cgi_pipeline.core.rt.IndexProperty_SetFileName(self.handle, value)

    filename = property(get_filename, set_filename)
    """Index filename for disk storage"""

    def get_dat_extension(self):
        ext = cgi_pipeline.core.rt.IndexProperty_GetFileNameExtensionDat(self.handle)
        return ext.decode()

    def set_dat_extension(self, value):
        if isinstance(value, str):
            value = value.encode("utf-8")
        return cgi_pipeline.core.rt.IndexProperty_SetFileNameExtensionDat(self.handle, value)

    dat_extension = property(get_dat_extension, set_dat_extension)
    """Extension for .dat file"""

    def get_idx_extension(self):
        ext = cgi_pipeline.core.rt.IndexProperty_GetFileNameExtensionIdx(self.handle)
        return ext.decode()

    def set_idx_extension(self, value):
        if isinstance(value, str):
            value = value.encode("utf-8")
        return cgi_pipeline.core.rt.IndexProperty_SetFileNameExtensionIdx(self.handle, value)
    ...
    def get_custom_storage_callbacks_size(self) -> int:
        return cgi_pipeline.core.rt.IndexProperty_GetCustomStorageCallbacksSize(self.handle)

    def set_custom_storage_callbacks_size(self, value: int) -> None:
        return cgi_pipeline.core.rt.IndexProperty_SetCustomStorageCallbacksSize(self.handle, value)
    ...
    def get_custom_storage_callbacks(self):
        return cgi_pipeline.core.rt.IndexProperty_GetCustomStorageCallbacks(self.handle)

    def set_custom_storage_callbacks(self, value):
        return cgi_pipeline.core.rt.IndexProperty_SetCustomStorageCallbacks(self.handle, value)
    ...
    def get_index_id(self):
        return cgi_pipeline.core.rt.IndexProperty_GetIndexID(self.handle)

    def set_index_id(self, value):
        return cgi_pipeline.core.rt.IndexProperty_SetIndexID(self.handle, value)
...
class ICustomStorage:
    ...
    def allocateBuffer(self, length):
        return cgi_pipeline.core.rt.SIDX_NewBuffer(length)
