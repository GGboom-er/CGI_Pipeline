# cgi_pipeline/core/path_guard.py
# ── 服务器路径保护 — AI 执行第一性原则 ──
#
...
#
# 用法：
#   from cgi_pipeline.core.path_guard import assert_save_allowed, is_protected_path
...
from cgi_pipeline.core.manifest import get_readonly_drives, get_readonly_unc_prefixes
